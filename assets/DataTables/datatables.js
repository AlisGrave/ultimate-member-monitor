 ...
 *   https://datatables.net/download/#dt/dt-2.1.8/b-3.2.0/b-colvis-3.2.0/r-3.0.3
 *
 * Included libraries:
 *   DataTables 2.1.8, Buttons 3.2.0, Column visibility 3.2.0, Responsive 3.0.3
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "dt/dt-2.1.8/b-3.2.0/b-colvis-3.2.0/r-3.0.3",
